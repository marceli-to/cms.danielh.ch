...
return [
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'Daniel H.'),

    'custom_logo_url' => env('STATAMIC_CUSTOM_LOGO_URL', '/logo.svg'),

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/apple-touch-icon.png'),
